    ...
    <section className="hero-shell" id="home" style={{ position: 'relative' }}>
      ...
      >
        <motion.div className="hero-founder-item" variants={itemVariants}>
          <img src="/founder.jpg" alt="Shri P.R. Ramasubrahmaneya Rajha" className="hero-founder-photo" />
        ...
        <motion.div className="hero-founder-item" variants={itemVariants}>
          <img src="/chairman.jpg" alt="Shri P.R. Venketrama Raja" className="hero-founder-photo" />
          <div className="hero-founder-info">
