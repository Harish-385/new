                  ...
                  {data.metrics && (data.metrics.citationsScopus > 0 || data.metrics.journals > 0) && (
                    <div className="profile-section-box">
                      ...
                      <div className="metrics-dashboard-grid" style={{
                        ...
                        {data.metrics.scopeIndexedArticles !== undefined && (
                          <div className="metric-dashboard-card color-scope" style={{
                          ...
                          onMouseEnter={(e) => {
                            e.currentTarget.style.transform = 'translateY(-3px)';
                            e.currentTarget.style.boxShadow = '0 10px 15px -3px rgba(14, 165, 233, 0.15), 0 4px 6px -2px rgba(14, 165, 233, 0.05)';
                            e.currentTarget.style.borderColor = 'rgba(14, 165, 233, 0.5)';
                          }}
                          onMouseLeave={(e) => {
                            e.currentTarget.style.transform = 'none';
                            e.currentTarget.style.boxShadow = '0 4px 6px -1px rgba(14, 165, 233, 0.05), 0 2px 4px -1px rgba(14, 165, 233, 0.03)';
                            e.currentTarget.style.borderColor = 'rgba(14, 165, 233, 0.25)';
                          }}>
                            <h4 style={{ margin: '0 0 8px 0', fontSize: '12px', color: '#0284c7', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: '700' }}>Scope Indexed Article</h4>
                            <span style={{ fontSize: '32px', fontWeight: '800', color: '#0284c7' }}>{data.metrics.scopeIndexedArticles}</span>
                          </div>
                        )}
