...
const RIT_DEPARTMENTS: DepartmentItem[] = [
  ...
  },
  {
    ...
    icon: Settings, // We can use Shield, but Settings is safe, or we can import Shield
    ...
    <section className="interests-section reveal-section" id="interests">
      <div className="interests-container">
        <div className="interests-header-row">
          <h2 className="interests-title" style={{ fontSize: 'clamp(1.8rem, 3.2vw, 2.4rem)' }}>WHAT'S YOUR INTEREST?</h2>
        </div>
